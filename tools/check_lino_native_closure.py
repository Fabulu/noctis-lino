...
FLOAT_SIGNATURES = {
    ...
    "work/vhground.txt": (
        ...
        "[FS0] = [VHGNDmushxf]; => FLoadF32; [FB0] = [FA0]; [FB1] = [FA1]; [FA0] := [FI];",
        "[FA0] +: [FB0]; ~: [FA0]; => FStoreF32;",
        "[VHGNDmushxf] = [FS0]; [PGFt] = [VHGNDmushxf]; [FI] =: [FA0]; [VHGNDmushx] = [FI];",
        "[FS0] = [VHGNDmushyf]; => FLoadF32; [FB0] = [FA0]; [FB1] = [FA1]; [FA0] := [FI];",
        "[FA0] +: [FB0]; ~: [FA0]; => FStoreF32;",
        "[VHGNDmushyf] = [FS0]; [PGFt] = [VHGNDmushyf]; [FI] =: [FA0]; [VHGNDmushy] = [FI];",
        "[FS0] = [VHGNDmushzf]; => FLoadF32; [FB0] = [FA0]; [FB1] = [FA1]; [FA0] := [FI];",
        "[FA0] +: [FB0]; ~: [FA0]; => FStoreF32;",
        "[VHGNDmushzf] = [FS0]; [PGFt] = [VHGNDmushzf]; [FI] =: [FA0]; [VHGNDmushz] = [FI];",
        "[FI] = C; [FB0] := [FI]; [PGFt] = [VHGNDmushzf]; [FS0] = [VHGNDmushzf]; => FLoadF32;",
        "[FA0] -: [FB0]; ~: [FA0]; => FStoreF32; [VHGNDmushpzf] = [FS0]; -> VHGND greenmush z ready;",
        "[FI] = C; [FB0] := [FI]; [PGFt] = [VHGNDmushyf]; [FS0] = [VHGNDmushyf]; => FLoadF32;",
        "[FA0] -: [FB0]; ~: [FA0]; => FStoreF32; [VHGNDmushpyf] = [FS0]; -> VHGND greenmush y ready;",
        "[FI] = C; [FB0] := [FI]; [PGFt] = [VHGNDmushxf]; [FS0] = [VHGNDmushxf]; => FLoadF32;",
        "[FA0] -: [FB0]; ~: [FA0]; => FStoreF32; [VHGNDmushpxf] = [FS0]; -> VHGND greenmush x ready;",
