...
layout = json.loads((EVIDENCE / "production-layout.json").read_text(encoding="utf-8"))
review = json.loads((EVIDENCE / "semantic-review.json").read_text(encoding="utf-8"))
assert model["status"] == layout["status"] == review["status"] == "pass"
