...
assert candidate_source_sha256 == "c5371564938a10000d0083499af53b3ed044378f2bf449a390f5461fcba87257"
assert candidate_executable_sha256 == "0655adbf3d48540625b3aa35dc4bc8c76d85c7a34fddf1cc8c7b0c7992d4a538"
...
assert model["status"] == "pass" and model["cases"] == 3572
assert model["candidate_file_equals_exact_transform"]
assert model["concrete_a_through_e_owner_guard_and_helper_terminal_state_exact"]
assert model["distance_terminal_fsw0_is_exact_relative_x_square"]
...
result = {
    "schema": 1,
    "task": 215,
    "candidate": "folded nearest-primary resident scan with exact final-primary replay",
