...
TESTS = [
    ...
    ("test_native_closure.py", "all shipping targets share the canonical tracked Lino source closure, which contains zero target blocks and retains the exact reviewed 36-operation float inventory"),
