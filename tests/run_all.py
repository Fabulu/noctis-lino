...
TESTS = [
    ...
    ("test_sun_gallery.py", "eleven retained surface-sun oracles across types 1/2/3/4/5/7/8 plus case-specific palette, band/crop, camera, admission, and positive/lower/upper ray-distance contracts"),
