...
TESTS = [
    ...
    ("test_orbitprimary_class11_runtime.py", "private-desktop POE capture protects the current class-11 phase-positive radial flare, exact crop bands, and fresh-process source gate"),
