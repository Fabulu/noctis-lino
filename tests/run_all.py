...
TESTS = [
    ...
    ("test_sun_gallery.py", "retained native type-3 sun BMP/page/palette plus exact product palette, palette-band, flare-centre, camera, and solar-state diagnostics; whole-page equality stays informational until snapshot-time state is retained"),
