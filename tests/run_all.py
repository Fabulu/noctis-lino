...
TESTS = [
    ...
    ("test_sun_gallery.py", "retained type-1/2/3/4/5/7/8 surface-sun oracles plus case-specific palette, band/crop, camera, admission, and positive/lower/upper ray-distance contracts"),
