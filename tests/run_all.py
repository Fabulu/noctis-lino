...
TESTS = [
    ...
    ("test_orbitlunar_oracle.py", "matched IDEAL lunar exterior/interior pages protect orbital pose signs, the target globe, and a primary flare through the Stardrifter"),
