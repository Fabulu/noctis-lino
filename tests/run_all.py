...
TESTS = [
    ...
    ("test_sun_gallery.py", "retained native type-3/type-5 sun BMP/page/palette oracles plus exact product palette, palette-band, flare-admission, camera, and solar-state diagnostics; low-six-bit centre and whole-page equality stay informational without snapshot-time state"),
