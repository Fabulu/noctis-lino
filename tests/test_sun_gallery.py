...
The default mode is non-GUI: it validates sixteen pinned NIV+ BMP oracles and the
...
CASES = {
    ...
    "lunar-class1-sun50": {
        "scene": "lunarclass1",
        "oracle": ROOT / "tests" / "native-oracles" / "lunar-class1-sun50"
        / "native.shot.BMP",
        "surface": ROOT / "tests" / "native-oracles" / "lunar-class1-sun50"
        / "native.SURFACE.BIN",
        "bmp_sha256": "f6f5093dfaf4be7f339da58845233ecdf8930bc3f43297ee89014501d4bbf11c",
        "surface_sha256": "8bb6cba9e72852ff5ad9b6846696f60ace162bf9c9dc2665f8410b1b2326bfe8",
        "surface_state": (
            50, 60, 100, 100, 8192, 8192,
            1638400.0, 1.0, 1638400.0, -30.0, 90.0,
        ),
        "page_sha256": "e191fc2841a00ab4c5ef63823ed1bc2ecdc5349c750eb76f0dd5919d074633b5",
        "palette_sha256": "90bb990e6edc353b2a682ca156aae2a802c75019d29046a48287dbb5c008b1de",
        "checkpoint_sha256": "97e18c3dc839be8a0cbacfe938d5e6de8f0bf8b8df2196f311119327feb2e461",
        "checkpoint": {
            "star_x": 2952848,
            "star_y": -6448045,
            "star_z": -840503,
        ...
        "clock": 1345636830,
        "view": (1638400, -14936, 1638400, -30, 90),
        "center": (161, 91),
        "native_center": 78,
        "full_band_exact": True,
        "palette_exact": True,
    ...
    "lunar-class3-sun75": {
        "scene": "lunarclass3",
        "oracle": ROOT / "tests" / "native-oracles" / "lunar-class3-sun75"
        / "native.shot.BMP",
        "surface": ROOT / "tests" / "native-oracles" / "lunar-class3-sun75"
        / "native.SURFACE.BIN",
        "bmp_sha256": "cb8c4d22ddd098fd6dc9e20a04769ba7d863acddfd5d35932cf9a4297d0b522a",
        "surface_sha256": "4891b835291f0b0f717c9044d26ada2df101bb09645d1b73a47a56433d3f9122",
        "surface_state": (
            75, 60, 100, 100, 8192, 8192,
            1638400.0, 1.0, 1638400.0, -34.0, 270.0,
        ),
        "page_sha256": "a4229d3e139354506136409f93ef5ecd6eed8eae33d7a8c4d7ef1a379e05b2c1",
        "palette_sha256": "16d8b262b94d5e443b12963b9faaf1a8e95d4dde88d1b47ac6662c0a5e4b8a4f",
        "checkpoint_sha256": "0c9242398a807fe8a61ce4ef3189ed33c7a4dbb7517506a4cc61defe4ab92e64",
        "checkpoint": {
            "star_x": 3363568,
            "star_y": -4274032,
            "star_z": -2404452,
        ...
        "clock": 1345723230,
        "view": (1638400, -49752, 1638400, -34, -90),
        "center": (161, 71),
        "native_center": 73,
        "center_exact": True,
        "full_band_exact": False,
        "exact_crop": (40, 10, 310, 150),
        "palette_exact": True,
        "beam_gate": "positive",
        "product": {
            "mode": 1,
    ...
    "lunar-class9-sun135": {
        "scene": "lunarclass9",
        "oracle": ROOT / "tests" / "native-oracles" / "lunar-class9-sun135"
        / "native.shot.BMP",
        "surface": ROOT / "tests" / "native-oracles" / "lunar-class9-sun135"
        / "native.SURFACE.BIN",
        "bmp_sha256": "85c257928f307b9d75bdb69d3afa919201b5d8de6ee377f583d51d9ed3d3c9d8",
        "surface_sha256": "c858b3429baf8272e3eba62c2fe0612db8587c0c005fa3f2828288d0f2cccf8f",
        "surface_state": (
            135, 60, 100, 100, 8192, 8192,
            1638400.0, 1.0, 1638400.0, -34.0, 270.0,
        ),
        "page_sha256": "4489f211257b83614d1eecf82576efbfd3e803a3a8e6b7e29c3aba032fb1d641",
        "palette_sha256": "5183075f60cb8abed98d24fe9f2b979adf5f1bdcc3436c8d2c534a1f8d612539",
        "checkpoint_sha256": "2a35eb60d254790d8fabfd893aa9cf2bce4a119a87483730bddd5e27b7eb195d",
        "checkpoint": {
            "star_x": 1405360,
            "star_y": -789781,
            "star_z": -1941535,
        ...
        "clock": 1345723230,
        "view": (1638400, -6744, 1638400, -34, -90),
        "center": (161, 56),
        "native_center": 70,
        "center_exact": True,
        "full_band_exact": True,
        "exact_crop": (40, 10, 310, 192),
        "palette_exact": True,
        "beam_gate": "positive",
        "product": {
            "mode": 1,
    ...
    "lunar-class11-sun135": {
        "scene": "lunarclass11",
        "oracle": ROOT / "tests" / "native-oracles" / "lunar-class11-sun135"
        / "native.shot.BMP",
        "surface": ROOT / "tests" / "native-oracles" / "lunar-class11-sun135"
        / "native.SURFACE.BIN",
        "bmp_sha256": "e1eca960e63efec582e3c32c8fae5ae5d7109aa4a83186d46ff8550cc161bb08",
        "surface_sha256": "c858b3429baf8272e3eba62c2fe0612db8587c0c005fa3f2828288d0f2cccf8f",
        "surface_state": (
            135, 60, 100, 100, 8192, 8192,
            1638400.0, 1.0, 1638400.0, -34.0, 270.0,
        ),
        "page_sha256": "17c25bcb97300107f83dc494e9eb115ec294def23fbeba2093fa143d0bcff596",
        "palette_sha256": "2fdd396ff08a4586cc15efd52b32cae41f280610f5d388b62e63925d38d2032c",
        "checkpoint_sha256": "bd71b63e6101a6297a980b2a1222c97dc88db88c24ef3039ff01207fe9579ba1",
        "checkpoint": {
            "star_x": 4879984,
            "star_y": -4603699,
            "star_z": -1023471,
    ...
    "dense-class8-sun0": {
        "scene": "denseclass8",
        "oracle": ROOT / "tests" / "native-oracles" / "dense-class8-sun0"
        / "native.shot.BMP",
        "surface": ROOT / "tests" / "native-oracles" / "dense-class8-sun0"
        / "native.SURFACE.BIN",
        "bmp_sha256": "16d54dacda5231d7a0034c40295450e87b52cfde061a24f1763530397253f5bc",
        "surface_sha256": "0970f803529c10431eb46a5f6a5a30a145f98660cd21b27e645eafd512a9399a",
        "surface_state": (
            0, 60, 100, 100, 8192, 8192,
            1638400.0, 1.0, 1638400.0, -30.0, 90.0,
        ),
        "page_sha256": "f0f2d630e6fb677edb570077f97e38175bfaa42def729a1c21358fd519eb8f45",
        "palette_sha256": "15c0987fb84ca7a2aaed5c2d2a34817e4d6cc3e9f046574a6559d4200fa5ff24",
        "checkpoint_sha256": "0079f12fe73262a9663219a7e05e9c10609e717ad7d5c8ab8c87afd3022edf10",
        "checkpoint": {
            "star_x": -1996240944,
            "star_y": 72703,
            "star_z": 944799,
        ...
        "clock": 1345636830,
        "view": (1638400, -244312, 1638400, -30, 90),
        "center": (161, 85),
        "native_center": 60,
        "full_band_exact": True,
        "palette_exact": False,
    ...
    "rocky-class1-sun180": {
        "scene": "rockyclass1",
        "oracle": ROOT / "tests" / "native-oracles" / "rocky-class1-sun180"
        / "native.shot.BMP",
        "surface": ROOT / "tests" / "native-oracles" / "rocky-class1-sun180"
        / "native.SURFACE.BIN",
        "bmp_sha256": "3d0082eca8f2dc26759ff48eb7e19a5786601c0c23b0801addb0b74b32f55ba8",
        "surface_sha256": "95cb83c43172d18799b58f65cee14cbd701690271c1f5bee04a76e0d97c0e48f",
        "surface_state": (
            180, 60, 100, 100, 8192, 8192,
            1638400.0, 1.0, 1638400.0, -10.0, 270.0,
        ),
        "page_sha256": "f87bab92428a89bbdd17cb0ddf65ac63dca65954dd9b494dc8fd1418cf12f0b9",
        "palette_sha256": "20480ec2fd03efb83ff3e3ac8a0480fa590c8ec7e7f0e9fe127ead90ab91073a",
        "checkpoint_sha256": "6c2a12ec58a60a3654cbf742b6a540d30244da37c93ab2c656358fc3fa0a8f0a",
        "checkpoint": {
            "star_x": 2952848,
            "star_y": -6448045,
            "star_z": -840503,
        ...
        "clock": 1345723230,
        "view": (1638400, -8792, 1638400, -10, -90),
        "center": (161, 72),
        "native_center": 126,
        "center_exact": True,
        "full_band_exact": False,
    ...
    "rocky-class2-sun0": {
        "scene": "rockyclass2",
        "oracle": ROOT / "tests" / "native-oracles" / "rocky-class2-sun0"
        / "native.shot.BMP",
        "surface": ROOT / "tests" / "native-oracles" / "rocky-class2-sun0"
        / "native.SURFACE.BIN",
        "bmp_sha256": "ea6696f9ad039d0c0409b60ec8997855d1e15c1ca284650ec10b46b4d7f4796d",
        "surface_sha256": "dcad65a8be49d3522b125625c8f82147b1c80bf1ab59c7812db0c35274203352",
        "surface_state": (
            0, 60, 100, 100, 8192, 8192,
            1638400.0, 1.0, 1638400.0, -12.0, 270.0,
        ),
        "page_sha256": "529d63dec71e53a999f2dfc88da926363cad5511c95bb71ed6272105a71ca9b4",
        "palette_sha256": "87b403eee35a762a83175163c3fd9a48c30339c3a0fe2188c56aa3d4d3b52b03",
        "checkpoint_sha256": "3bedb6f7fedba26e9fd326edd5d92feaa34df61bb5343fe2f7f34574ccfaef82",
        "checkpoint": {
            "star_x": 5800336,
            "star_y": -4462999,
            "star_z": -925592,
        ...
        "clock": 1345723230,
        "view": (1638400, -10840, 1638400, -12, -90),
        "center": (161, 100),
        "native_center": 108,
        "center_exact": True,
        "full_band_exact": False,
...
def check_source_contract(check) -> None:
    ...
    check(all(fragment in macos_workflow for fragment in (
              ...
              '"case": "lunar-class9-sun135"',
              '"case": "lunar-class11-sun135"',
              '"case": "dense-sun0"',
              '"case": "dense-class8-sun0"',
              '"case": "rocky-sun90"',
              '"case": "rocky-class1-sun180"',
              '"case": "rocky-class2-sun0"',
              '"case": "frozen-sun0"',
              '"case": "quartz-sun228"',
              '"scene": "habitable"',
              '"scene": "thin"',
          ...
          "hosted Apple-Silicon gate executes and retains all sixteen surface-sun cases")
