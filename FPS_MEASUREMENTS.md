...
| Task #187 Baseline A, current production record | `81900287fa9e19291a27667b0e23d5c0c6324e86e8b9d8da0ff82a65cc302823` | **60.15187849720224 Hz** | **18.585131894484412 Hz** | 9.426001134790807 ms | 7.291808423047645 ms | 0.5577711347390241 ms | **38,184,297.03654485** | `build/gui-deferred-demotions-20260829/baseline-a/capsule/report.json` |

The first row was 5.026178010471206 Hz short of 60. Task #125's retained-lineage observation then closed the measured gap to 0.19331453886427852 Hz. Tasks #127, #140, #145, #149, #153, #167, and #185 each retained a depressed/variable-host relative win without replacing it. Task #187's unchanged-production Baseline A now establishes the first controlled fixed-discriminator result above target, exceeding 60 Hz by 0.15187849720224267 Hz; sustained acceptance beyond the five-second discriminator remains separate.

## Sustained current-production acceptance

These opt-in terminal profiles run the unchanged Task #185 production executable on the private inactive desktop, physical core 3 / affinity `0xc0`, and above-normal priority. Surface runs hold W for the first five seconds, preserve the 320x200 full-fidelity renderer, and measure presentation, authoritative simulation, renderer phases, deadlines, cycles, and input latency independently.
