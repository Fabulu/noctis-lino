...
- The complete macOS app smoke is proven on Apple Silicon through Rosetta 2.
  ...
  observable C2/status output, multi-step partial-remainder behavior, and remaining
