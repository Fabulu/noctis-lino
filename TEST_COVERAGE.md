...
- The complete macOS app smoke is proven on Apple Silicon through Rosetta 2.
  ...
  ordinary/signaling-NaN payload equivalence, exact FP exception-state
  compatibility, x87 large-argument trigonometric range reduction, multi-step
  partial-remainder behavior, and remaining exception/transcendental semantics; no
  native macOS runtime, Cocoa application, or native ARM64 Noctis build exists yet.
